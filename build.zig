...
pub fn build(b: *std.Build) void {
    ...
    const exeMod = b.createModule(.{
        ...
        // root module.
        .imports = &.{
            // Here "umac" is the name you will use in your source code to
            // import this module (e.g. `@import("umac")`). The name is
            // repeated because you are allowed to rename your imports, which
            // can be extremely useful in case of collisions (which can happen
            // importing modules from different packages).
            .{ .name = "umac", .module = mod },
        },
    });

    exeMod.addIncludePath(.{ .cwd_relative = "/opt/homebrew/Cellar/openssl@3/3.6.0/include" });
